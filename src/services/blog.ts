...
import { BlogByCategoryResponse, BlogBySlugApiResponse, BlogCategoryResponse } from "@/types/blog.interface";
...
export const fetchBlogBySlug = async (slug: string): Promise<BlogBySlugApiResponse> => {
  try {
...
export const searchBlogs = async (
  ...
  try {
    let url = `${API_BASE_URL}api/blog?page=${page}&search=${encodeURIComponent(
      query
    )}`;
    if (categoryId) {
